...
- Clone the repo
- Open the solution in Visual Studio (2022 is what I used for the build)
- Run the API project
- Open a terminal in the blackjack_praeses_client folder
  - Easier to open the client folder in VS Code so you can separate it all out a little cleaner but that's just me.
- Run "npm install"
- Run "npm run dev"
